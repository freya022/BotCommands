...
class IntegrationTest {
    ...
    class MyBundleReader(
        ...
        override fun readLocalizationMap(request: LocalizationMapRequest): LocalizationMap? {
            ...
            return DefaultLocalizationMap(request.requestedLocale, mapOf(
                "whats.the.fox.doing" to DefaultLocalizationTemplate(context, "The fox quickly {action}", request.requestedLocale),
            ))
        }
    }
