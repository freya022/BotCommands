...
object TextUtils {
    ...
    private fun generateDescription(commandInfo: TextCommandInfo, event: BaseCommandEvent) = buildString {
        ...
        val prefix = event.context.getService<TextCommandsContext>().getPreferredPrefix(event.guildChannel) ?: throwInternal("Cannot generate help content without a prefix")
