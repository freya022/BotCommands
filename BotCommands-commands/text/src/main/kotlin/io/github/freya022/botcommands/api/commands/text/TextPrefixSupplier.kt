...
interface TextPrefixSupplier {
     ...
     * you'll need to pass back those ([BTextConfig.prefixes] + [JDA.getSelfUser().asMention][IMentionable.getAsMention]).
     *
     ...
     * or [JDA.getSelfUser().asMention][IMentionable.getAsMention]).
     *
