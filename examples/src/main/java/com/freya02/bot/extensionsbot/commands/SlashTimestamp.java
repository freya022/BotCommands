...
public class SlashTimestamp extends ApplicationCommand {
	...
	public void run(GuildSlashEvent event, @Option Timestamp timestamp /*This parameter works as it has been registered in ExtensionsBotMain with a TimestampResolver */) {
