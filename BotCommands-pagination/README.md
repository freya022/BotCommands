[bc-module-maven-central-shield]: https://img.shields.io/maven-central/v/io.github.freya022/BotCommands-pagination?label=Maven%20central&logo=apachemaven&versionPrefix=3
...
Provides various types of pagination, using components.
...
<dependencies>
  <dependency>
    ...
    <artifactId>BotCommands-pagination</artifactId>
...
dependencies {
    implementation("io.github.freya022:BotCommands-pagination:VERSION")
}
```
