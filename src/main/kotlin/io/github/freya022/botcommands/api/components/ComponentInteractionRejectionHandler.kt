...
interface ComponentInteractionRejectionHandler {
    @JvmSynthetic
    suspend fun handleSuspend(event: GenericComponentInteractionCreateEvent, handlerName: String?, userData: Any): Unit =
        handle(event, handlerName, userData)

    fun handle(event: GenericComponentInteractionCreateEvent, handlerName: String?, userData: Any): Unit =
