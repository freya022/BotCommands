 ...
 *
 * These filters will be applied to every component.
 *
 ...
 *     ): GlobalComponentInteractionFilter<String> = adminFilter and inVoiceChannelFilter
 * }
 * ```
 *
 * ### Requirements
 ...
 *
 * ### Execution order
 * The execution order is determined by the [service priority][ServicePriority].
 *
...
interface GlobalComponentInteractionFilter : ComponentInteractionFilter {

    companion object {
        @JvmStatic
        @JvmName("or")
        fun orJava(left: GlobalComponentInteractionFilter, right: GlobalComponentInteractionFilter): GlobalComponentInteractionFilter {
            return left or right
        }

        @JvmStatic
        @JvmName("and")
        fun andJava(left: GlobalComponentInteractionFilter, right: GlobalComponentInteractionFilter): GlobalComponentInteractionFilter {
            return left and right
        }
    }
}

infix fun GlobalComponentInteractionFilter.or(other: GlobalComponentInteractionFilter): GlobalComponentInteractionFilter {
    return object : GlobalComponentInteractionFilter {
...
infix fun GlobalComponentInteractionFilter.and(other: GlobalComponentInteractionFilter): GlobalComponentInteractionFilter {
    return object : GlobalComponentInteractionFilter {
        override val description: String
