...
class GlobalApplicationCommandManager internal constructor(context: BContext): AbstractApplicationCommandManager(context) {
    override val defaultScope = CommandScope.GLOBAL

    override val supportedContexts: Set<InteractionContextType> = InteractionContextType.ALL
    override val supportedIntegrationTypes: Set<IntegrationType> = IntegrationType.ALL
