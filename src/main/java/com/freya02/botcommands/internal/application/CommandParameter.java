...
public abstract class CommandParameter<RESOLVER> {
	...
	public CommandParameter(@Nullable Class<RESOLVER> resolverType, KParameter parameter, int index) {
		this(resolverType, parameter, parameter.getType(), index);
	}

	public CommandParameter(@Nullable Class<RESOLVER> resolverType, KParameter parameter, KType boxedType, int index) {
	...
	@NotNull
	public KType getBoxedType() {
		return boxedType;
	}

	@NotNull
	public KParameter getParameter() {
		return parameter;
	}
