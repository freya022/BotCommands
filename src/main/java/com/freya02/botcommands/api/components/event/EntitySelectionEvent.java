...
public class EntitySelectionEvent extends StringSelectInteractionEvent implements LambdaLocalizable {
	private final EventLocalizer localizer;

	private final BContext context;

	public EntitySelectionEvent(@Nullable Method method, BContextImpl context, StringSelectInteractionEvent event) {
