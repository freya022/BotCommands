 ...
 *     <li>You can optionally add more parameters, these are similar to commands "custom parameters" and are added with {@link ExtensionsBuilder#registerCustomResolver(Class, Function)} which is found in {@link CommandsBuilder#extensionsBuilder(Consumer)}</li>
 * </ul>
 */
