...
/**
 * @see #get(MessageBuilder, PaginatorComponents, int)
 */
public interface PaginatorSupplier {
	/**
	 ...
	 */
	@NotNull
	MessageEmbed get(@NotNull MessageBuilder messageBuilder, @NotNull PaginatorComponents components, int page);
}
