...
/**
 * @see #get(T, MessageBuilder, PaginatorComponents)
 */
public interface InteractiveMenuSupplier<T extends BasicInteractiveMenu<T>> {
	 ...
	 */
	@NotNull
	MessageEmbed get(@NotNull T interactiveMenu, @NotNull MessageBuilder messageBuilder, @NotNull PaginatorComponents components);
}
