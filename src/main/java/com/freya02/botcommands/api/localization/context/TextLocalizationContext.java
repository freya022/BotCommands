...
public interface TextLocalizationContext extends LocalizationContext {
     ...
     *
     * <p><b>Note:</b> If the context does not provide a guild locale (such as text commands) but the event comes from a {@link Guild} and is a community,
     * then the community's locale will be returned, or {@link DiscordLocale#ENGLISH_US} by default.
     *
