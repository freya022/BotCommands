...
/**
 * Annotation for defining a button listener, this has to be the same name as the id given to {@link ButtonListener#getButtonId(SlashCommandEvent, String, Object...)}
 * <p>
